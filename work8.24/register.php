...
<head>
    <title>用户注册页面 </title>
<script type="text/javascript" src="registerCheck.js"> </script>
</head>
...
<td><input type="radio" name="sex" value="0"/>女</td>
        ...
        <div class="layout">
<td>爱好：</td>
<td><input type="checkbox" id="love0" name="love"value="music" checked="checked"/> 听音乐<td/>

<td><input type="checkbox" id="love1" name="love" value="movie"/> 看电影<td/>

<td><input type="checkbox" id="love2" name="love" value="game"/> 玩游戏<td/>
        </div>
            <div class="layout">
<td>您所在的城市：</td>
<td><select name="city">
